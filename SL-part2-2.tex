...
\figura[10]{fuente}{Código fuente en lenguaje C}{bibliotecas-src-0.eps}

\figura{objeto}{Código objeto procedente del programa en C}{objeto.png}


\figura[10]{bibsrc1}{Un archivo fuente que usa dos funciones externas}{bibliotecas-src-1.eps}
